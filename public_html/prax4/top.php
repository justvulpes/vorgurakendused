    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="top.php">top<span class="sr-only">(current)</span></a>
                </li>
            </ul>
        ...
        <div class="row newsfeed">
            <div class="col-sm-8 blog-main">
                ...
                function showNews() {
                    ...
                    $q = "SELECT * FROM (SELECT news_id as nid, SUM(score) as scoresum FROM t164036v1_news_score GROUP by news_id ORDER BY scoresum DESC) as gold INNER JOIN t164036v3_news ON t164036v3_news.id=gold.nid;;";
                    if ($q === "") {
//                        echo "No query";
                    } else {
